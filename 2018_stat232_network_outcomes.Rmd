...
## Discussion -- a preview

* Employing randomization inference in settings with network-correlated
  outcomes
  1. How may we construct settings in which estimators are endowed with
     desirable properties (e.g., unbiasedness, "optimality")?

  2. How can we leverage modern development (e.g., re-randomization) to build
